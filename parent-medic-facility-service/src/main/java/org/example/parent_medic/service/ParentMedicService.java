package org.example.parent_medic.service;

import com.google.protobuf.Timestamp;
import lombok.extern.slf4j.Slf4j;
import org.apache.dubbo.config.annotation.DubboService;
import org.example.dubbo.*;
import org.example.parent_medic.repository.IRepository;
...
public class ParentMedicService extends DubboParentMedicTriple.ParentMedicImplBase {
    ...
    public ParentMedicFacility save(ParentMedicFacility request) {
        var parentMedicReq = org.example.parent_medic.entity.ParentMedicFacility
                .builder()
    ...
    public ParentMedicFacility get(ParentMedicFacilityParam request) {
        var reqParam = org.example.parent_medic.entity.ParentMedicFacilityParam
                .builder()
                .id(request.getId())
                .pgParam(
    ...
    private ParentMedicFacility convertEntityIntoPbMessage(org.example.parent_medic.entity.ParentMedicFacility data){
        var respBuilder =  ParentMedicFacility
                .newBuilder()
                .setId(data.getId())
                .setFkParentId(data.getFkParentId())
