...
public class ParentMedicService extends DubboParentMedicTriple.ParentMedicImplBase {
    ...
    public ParentMedicFacility save(ParentMedicFacility request) {
        var parentMedicReq = org.example.entity.ParentMedicFacility
                .builder()
    ...
    public ParentMedicFacility get(ParentMedicFacilityParam request) {
        var reqParam = org.example.entity.ParentMedicFacilityParam
                .builder()
                .id(request.getId())
                .pgParam(
    ...
    private ParentMedicFacility convertEntityIntoPbMessage(org.example.entity.ParentMedicFacility data){
        var respBuilder =  ParentMedicFacility
                .newBuilder()
                .setId(data.getId())
                .setFkParentId(data.getFkParentId())
